...
<div>
    ...
    <label for="<?php echo $this->get_field_id('twb_list_name'); ?>">
      <?php _e('Aweber List ID *(Required)'); ?>
    </label>
    <br />
	
<input type="text" id="<?php echo $this->get_field_id('twb_list_name'); ?>" name="<?php echo $this->get_field_name('twb_list_name'); ?>" value="<?php echo $instance['twb_list_name']; ?>" style="width:60%;" />
<br>
...
<div class="twbsection">
<label for="<?php echo $this->get_field_id('twb_sub_title'); ?>">
<?php _e('Sub Title'); ?>

(HTML is allowed)</label>
<textarea rows="10" id="<?php echo $this->get_field_id('twb_sub_title'); ?>" name="<?php echo $this->get_field_name('twb_sub_title'); ?>" style="width:90%;" ><?php echo wpautop($instance['twb_sub_title']); ?> 
</textarea>
</div>
<div class="twbsection">
<label for="<?php echo $this->get_field_id('twb_ty_link'); ?>">
<?php _e('Link to the Thank you page'); ?>
</label>
<input id="<?php echo $this->get_field_id('twb_ty_link'); ?>" name="<?php echo $this->get_field_name('twb_ty_link');
?>" value="<?php echo $instance['twb_ty_link']; ?>" style="width:90%;" />
<br />
...
<div>
<div class="twbsection">
<label style="display:block; padding-bottom:5px;" for="<?php echo $this->get_field_id('twb_bg_color'); ?>">

<?php _e('Optin Background Color'); ?>
</label>

<input class="twb_color_picker twb-bg-color" id="<?php echo $this->get_field_id('twb_bg_color'); ?>" name="<?php echo $this->get_field_name('twb_bg_color'); ?>" type="text" value="<?php echo $instance['twb_bg_color']; ?>" />
<div class="twb_bg_color" rel="<?php echo $this->get_field_id('twb_bg_color'); ?>"></div>
</div>
<div class="twbsection">
<label>
<?php _e('Main Title Color'); ?>
</label>
<br>
...
<label>
<?php _e('Email Field (Always enabled)'); ?>
</label>
</div>
<div class="twbsection">
<label for="<?php echo $this->get_field_id('twb_ph_email'); ?>">

<?php _e('Placeholder Text For Email Field'); ?>
</label>
...
<div class="twbsection">
<input class="twb_check1" type="checkbox" <?php checked($instance['twb_name_check'], 'on'); ?> id="<?php echo $this->get_field_id('twb_name_check'); ?>" name="<?php echo $this->get_field_name('twb_name_check'); ?>" />

<label for="<?php echo $this->get_field_id('twb_name_check'); ?>">

<?php _e('Enable Full Name Field'); ?>
</label>

<div class="twbcheck1">
<label for="<?php echo $this->get_field_id('twb_ph_name'); ?>">
<?php _e('Placeholder Text For Full Name Field'); ?>
</label>
...
<label>
<?php _e('Enable First Name Field'); ?>
</label>
<br>
<strong>Available in Pro Version!</strong> </div>
<div class="twbsection">
...
<label>
<?php _e('Custom Fields (Coming Soon)'); ?>
</label>
</div>
<div class="twbsection">
<input class="twb_check4" type="checkbox" <?php checked($instance['twb_btn_check'], 'on'); ?> id="<?php echo $this->get_field_id('twb_btn_check'); ?>" name="<?php echo $this->get_field_name('twb_btn_check'); ?>" />
<label for="<?php echo $this->get_field_id('twb_btn_check'); ?>">
<?php _e('Use Button Image Instead'); ?>
</label>
<div class="twbcheck4">
<input id="<?php echo $this->get_field_id('twb_btn_img'); ?>" name="<?php echo $this->get_field_name('twb_btn_img'); ?>" value="<?php echo esc_attr($twb_btn_img); ?>" placeholder="Button Image URL" style="width:90%;" />

<br />
You can find links to FREE Online Button Generators <a target="_blank" href="http://theweb-designs.com/support/topic/free-online-button-generators/">HERE</a></div>
<div class="twbcheck4hide" style="margin-top:15px;">
<label for="<?php echo $this->get_field_id('twb_ph_btn'); ?>">
<?php _e('Submit Button Text'); ?>
</label>

<input type="text" id="<?php echo $this->get_field_id('twb_ph_btn'); ?>" name="<?php echo $this->get_field_name('twb_ph_btn');
?>" value="<?php echo $instance['twb_ph_btn']; ?>" style="width:90%;" />

<label style="display:block; padding-top:5px; padding-bottom:5px;" for="<?php echo $this->get_field_id('twb_ph_btn_color');
?>">
...
<input class="twb_color_picker twb" id="<?php echo $this->get_field_id('twb_ph_btn_color'); ?>" name="<?php echo $this->get_field_name('twb_ph_btn_color'); ?>" type="text" value="<?php echo $instance['twb_ph_btn_color']; ?>" />
<div class="twb_btn_color" rel="<?php echo $this->get_field_id('twb_ph_btn_color'); ?>"></div>

<label style="display:block; padding-bottom:5px;" for="<?php echo $this->get_field_id('twb_ph_btn_txt_color'); ?>">

<?php _e('Button Text Color:'); ?>

</label>

<input class="twb_color_picker twb-btn-txt-color" id="<?php echo $this->get_field_id('twb_ph_btn_txt_color'); ?>" name="<?php
echo $this->get_field_name('twb_ph_btn_txt_color'); ?>" type="text" value="<?php echo $instance['twb_ph_btn_txt_color']; ?>" />
...
<strong>Available in Pro Version!</strong> </div>
<div class="twbsection">
<label for="<?php echo $this->get_field_id('twb_onlist_redirect_url'); ?>">
<?php _e('Redirect Already Subscribed Users to Following URL'); ?>
</label>
<br />
...
<a href="http://theweb-designs.com/plugins/simple-aweber-optin-widget/" target="_blank" title="Buy Pro Version">
